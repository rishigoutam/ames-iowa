...
fig4 = ggplot(df_cleaned, aes(x = reorder(Neighborhood, SalePrice), y = SalePrice)) +
        geom_boxplot() +
        labs(x="Neighborhood") +
        coord_flip()
...
#df_Crushed = filter(df_Summary, Commodity=="Crushed Stone, Sand and Gravel")

#ggplot(df_Crushed, aes(x = Monthly_Carload, y = Index)) + 
