...
df_cleaned$Neighborhood_Int = factor(df_cleaned$Neighborhood_Int, levels = 0:27, ordered = TRUE)
...
df_temp = df_cleaned %>%
  select(PID, DateSold, Rate, logSalePrice, IsOnMainroad, IsNearPark, IsNearRailroad, LotConfig, LandSlope, LandContour, LotShape, StreetAlley, RemodSinceBuilt, Age, Neighborhood_Int)
