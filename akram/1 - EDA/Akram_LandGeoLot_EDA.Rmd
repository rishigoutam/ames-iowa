...
fig4 = ggplot(df_cleaned, aes(x = reorder(Neighborhood, SalePrice), y = SalePrice, fill=Neighborhood)) +
        ...
        labs(x="Neighborhood") +
        coord_flip() +
        stat_summary(fun.y=mean, geom="point", shape=17, size=1, color="red", fill="black")         + theme(legend.position = "none") + theme(axis.text = element_text(face="bold")) + theme(axis.title = element_text(face="bold"))
...
fig12 = ggplot(df_cleaned, aes(x = reorder(IsOnMainroad, SalePrice), y = SalePrice, fill=IsOnMainroad)) +
        ...
        coord_flip() +
        stat_summary(fun.y=mean, geom="point", shape=17, size=2, color="red", fill="black")       + theme(legend.position = c(0.842,0.5)) + scale_fill_discrete(labels = c("No (0)", "Yes (1)")) + theme(axis.text = element_text(face="bold")) + theme(axis.title = element_text(face="bold"))
...
cor.test(as.integer(df_cleaned$IsNearPark), df_cleaned$SalePrice, method=c("pearson"))
